...
prepare_stack_ensure_dir_from_env "AFL_SOURCE_PATH" "${HOME}/security-lab/afl/source"
prepare_stack_ensure_dir_from_env "AFL_OUTPUT_PATH" "${HOME}/security-lab/afl/output"
prepare_stack_end
