...
prepare_stack_ensure_dir_from_env "AUTH_FUZZ_WORDLIST_PATH" "${HOME}/security-lab/wordlists"
prepare_stack_ensure_dir_from_env "AUTH_FUZZ_OUTPUT_PATH" "${HOME}/security-lab/auth-fuzz-output"
prepare_stack_end
