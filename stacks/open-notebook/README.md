...
- Set `API_URL` in `.env` to the public URL you use in the browser (e.g. `https://notebook.yourdomain.com` or `https://open-notebook.home`). Caddy must route both the site and `/api*` to this stack.
