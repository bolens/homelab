    ...
    <article className='ui-page-shell asking-public-layout asking-about-page asking-terms-page' id='asking-terms-page'>
      ...
      <div className='asking-about-page__panels'>
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__contact-heading'>
        ...
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__eligibility-heading'>
            {t('terms.section.eligibility.title')}
          </h2>
          <p>{t('terms.section.eligibility.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__use-heading'>
            {t('terms.section.use.title')}
          </h2>
          <p>{t('terms.section.use.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__api-heading'>
            {t('terms.section.api.title')}
          </h2>
          <p>{t('terms.section.api.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__content-heading'>
        ...
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__ip-heading'>
            {t('terms.section.ip.title')}
          </h2>
          <p>{t('terms.section.ip.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__dmca-heading'>
            {t('terms.section.dmca.title')}
          </h2>
          <p>{t('terms.section.dmca.body')}</p>
          <ol className='asking-terms-page__ordered-list'>
        ...
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__accounts-heading'>
            {t('terms.section.accounts.title')}
          </h2>
          <p>{t('terms.section.accounts.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__privacy-heading'>
        ...
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__availability-heading'>
            {t('terms.section.availability.title')}
          </h2>
          <p>{t('terms.section.availability.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__indemnity-heading'>
            {t('terms.section.indemnity.title')}
          </h2>
          <p>{t('terms.section.indemnity.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__liability-heading'>
            {t('terms.section.liability.title')}
          </h2>
          <p>{t('terms.section.liability.body')}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__law-heading'>
            {t('terms.section.law.title')}
          </h2>
          <p>{lawBody}</p>
        </Card>

        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__changes-heading'>
        ...
        <Card as='section' className='asking-about-page__panel' padding='none'>
          <h2 className='ui-flow-heading' id='asking-terms-page__misc-heading'>
            {t('terms.section.misc.title')}
          </h2>
