...
prepare_stack_ensure_dir_from_env "EMBY_AUDIOBOOKS_PATH" "${MEDIA_ROOT:-/srv/media}/audiobooks"
prepare_stack_ensure_dir_from_env "EMBY_BOOKS_PATH" "${MEDIA_ROOT:-/srv/media}/kavita-books"
prepare_stack_end
