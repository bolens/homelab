...
DRY_RUN=$(to_01 "${DRY_RUN:-true}")
DRY_RUN_CONTAINERS=$(to_01 "${DRY_RUN_CONTAINERS:-$DRY_RUN}")
DRY_RUN_IMAGES=$(to_01 "${DRY_RUN_IMAGES:-$DRY_RUN}")
DRY_RUN_VOLUMES=$(to_01 "${DRY_RUN_VOLUMES:-$DRY_RUN}")
DRY_RUN_NETWORKS=$(to_01 "${DRY_RUN_NETWORKS:-$DRY_RUN}")
DRY_RUN_BUILD_CACHE=$(to_01 "${DRY_RUN_BUILD_CACHE:-$DRY_RUN}")
export DRY_RUN DRY_RUN_CONTAINERS DRY_RUN_IMAGES DRY_RUN_VOLUMES
export DRY_RUN_NETWORKS DRY_RUN_BUILD_CACHE
...
REMOVE_ASSOCIATED_VOLUME=$(to_01 "${REMOVE_ASSOCIATED_VOLUME:-1}")
FORCE_CONTAINER_REMOVAL=$(to_01 "${FORCE_CONTAINER_REMOVAL:-0}")
FORCE_IMAGE_REMOVAL=$(to_01 "${FORCE_IMAGE_REMOVAL:-0}")
EXCLUDE_DEAD=$(to_01 "${EXCLUDE_DEAD:-0}")
REMOVE_VOLUMES=$(to_01 "${REMOVE_VOLUMES:-0}")
LOG_TO_SYSLOG=$(to_01 "${LOG_TO_SYSLOG:-0}")
export REMOVE_ASSOCIATED_VOLUME FORCE_CONTAINER_REMOVAL FORCE_IMAGE_REMOVAL
export EXCLUDE_DEAD REMOVE_VOLUMES LOG_TO_SYSLOG
