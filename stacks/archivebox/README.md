...
| **Network** | `ingress-public` for Caddy; private `internal` network for scheduler and Sonic |
...
Ensure ArchiveBox is on `ingress-public` so Caddy can reach `archivebox:8000`.
