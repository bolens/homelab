...
**Docs:** https://infisical.com/docs/documentation/getting-started/overview  
...
| **Network** | `ingress-sensitive` for Caddy; `mail-clients` for SMTP; `infisical` internal for DB/Redis |
