...
with tempfile.TemporaryDirectory() as directory:
    ...
    (source / 'queues').mkdir()
    for name in ('webserve.py', 'getcomics.py', 'queues/ddl.py', 'cmtagmylar.py', 'api.py', 'PostProcessor.py', 'search.py'):
        shutil.copyfile(Path('/app/mylar3/mylar') / name, source / name)
    for patch in ('patch_ddl.py', 'patch_workers.py', 'patch_health.py', 'patch_integrity.py', 'patch_queue_progress.py', 'patch_queue_control.py', 'patch_search_cooldown.py', 'patch_queue_views.py', 'patch_pp_monitor.py', 'patch_wide_layout.py'):
