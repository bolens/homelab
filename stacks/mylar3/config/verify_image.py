...
with tempfile.TemporaryDirectory() as directory:
    ...
    for patch in ('patch_ddl.py', 'patch_workers.py', 'patch_health.py', 'patch_integrity.py', 'patch_queue_progress.py', 'patch_queue_control.py', 'patch_search_cooldown.py', 'patch_queue_views.py', 'patch_pp_monitor.py', 'patch_wide_layout.py', 'patch_workflow.py'):
