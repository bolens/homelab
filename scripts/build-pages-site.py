...
<div class="hero-actions"><a class="button primary" href="apps/">Browse applications</a><a class="button secondary" href="architecture/">See how it works</a></div><svg class="atlas-route" viewBox="0 0 720 104" role="img" aria-label="A request routed through the homelab gateway to a matching service"><path class="route-line" d="M20 52H174C224 52 224 20 274 20H430C480 20 480 84 530 84H700" pathLength="1"/><g><circle cx="20" cy="52" r="9"/><circle cx="274" cy="20" r="9"/><circle cx="530" cy="84" r="9"/><circle cx="700" cy="84" r="9"/></g><circle class="route-pulse" cx="20" cy="52" r="7"/></svg></section>
