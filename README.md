...
- **Developer & IT utilities:** it-tools, ConvertX, Dozzle, Gitea, Harbor, Woodpecker CI, Homarr dashboard, Baserow, Stirling-PDF, ntfy Stacks: baserow, convertx, dozzle, gitea, harbor, homarr, it-tools, ntfy, stirling-pdf, woodpecker-ci.
