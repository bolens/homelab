...
- **stacks/adguard-home** — copy `stack.env.example` → `stack.env` and set `ADGUARD_BIND_IP`. DNS binds to that host address on 53/853; web UI uses Caddy to `adguard-home:3000`.
