...
| **stacks/maigret** | OSINT: collect a dossier by homelab-user from thousands of sites (web UI, HTML/PDF/XMind reports) |
...
| **stacks/social-hunt** | OSINT framework: homelab-user search, breach lookups (HIBP/Snusbase), face match, reverse image |
